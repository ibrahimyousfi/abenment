<x-gym-layout>
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-6 flex items-center justify-between">
            ...
            <a href="{{ route('gym.members.show', $member) }}" class="text-gray-500 hover:text-gray-700 flex items-center gap-2 text-sm font-medium">
        ...
        <div class="bg-white border border-gray-100 overflow-hidden shadow-sm sm:rounded-2xl">
            <div class="p-8">
                ...
                <form method="POST" action="{{ route('gym.members.storeRenewal', $member) }}" class="space-y-8">
                    @csrf
