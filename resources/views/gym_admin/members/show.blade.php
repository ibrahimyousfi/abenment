<x-gym-layout>
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <div class="flex justify-between items-center no-print">
            ...
            <a href="{{ route('gym.members.index') }}" class="text-gray-500 hover:text-gray-700 flex items-center gap-2 text-sm font-medium transition">
        ...
        <div class="bg-white border border-gray-100 overflow-hidden shadow-sm sm:rounded-2xl">
            <div class="p-8">
                ...
                <div class="mt-8 pt-6 border-t border-gray-100 flex flex-wrap justify-end gap-3 no-print">
                    ...
                    <a href="{{ route('gym.members.renew', $member) }}" 
